...
/**
 * Sub-route error boundary for /destinations/[slug].
 * Catches data-fetch failures (invalid slug, missing destination) gracefully.
 */
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center px-6 md:px-12 py-16">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-lg text-[#1A1A1A]/70 leading-relaxed mb-8">
            We could not find this destination. It may have been removed or the link may be incorrect.
            Try again or explore all destinations.
          </p>
